...
public partial class InventoryServiceClient : System.ServiceModel.ClientBase<InventoryService>, InventoryService
{
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    getFilterValuesResponse1 InventoryService.getFilterValues(getFilterValuesRequest1 request)
    {
        return base.Channel.getFilterValues(request);
    }
    
    public GetFilterValuesResponse getFilterValues(GetFilterValuesRequest GetFilterValuesRequest)
    {
        getFilterValuesRequest1 inValue = new getFilterValuesRequest1();
        inValue.GetFilterValuesRequest = GetFilterValuesRequest;
        getFilterValuesResponse1 retVal = ((InventoryService)(this)).getFilterValues(inValue);
        return retVal.GetFilterValuesResponse;
    }
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    getInventoryLevelsResponse1 InventoryService.getInventoryLevels(getInventoryLevelsRequest1 request)
    {
        return base.Channel.getInventoryLevels(request);
    }
    
    public GetInventoryLevelsResponse getInventoryLevels(GetInventoryLevelsRequest GetInventoryLevelsRequest)
    {
        ...
        getInventoryLevelsResponse1 retVal = ((InventoryService)(this)).getInventoryLevels(inValue);
        return retVal.GetInventoryLevelsResponse;
    }
